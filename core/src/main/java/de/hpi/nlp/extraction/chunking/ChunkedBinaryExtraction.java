package de.hpi.nlp.extraction.chunking;

import com.google.common.collect.Iterables;
import edu.washington.cs.knowitall.commonlib.Range;
import de.hpi.nlp.chunking.ChunkedSentence;
import de.hpi.nlp.extraction.ExtractionConverter;
import de.hpi.nlp.extraction.SimpleBinaryRelation;
 ...
 * parts: two arguments (arg1 and arg2) and a relation (rel). Each of these parts corresponds to a
 * disjoint span of words in a sentence. The relation is represented as a {@link ChunkedExtraction}
 * object, and the two arguments are represented as {@link ChunkedArgumentExtraction} objects.
 *
 * @author afader
 */
