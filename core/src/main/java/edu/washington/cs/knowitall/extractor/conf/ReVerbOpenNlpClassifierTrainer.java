 ...
 * <code>ReVerbFeatures</code>. Given a set of <code>LabeledBinaryExtraction</code> instances, this
 * class featurizes them and trains a logistic regression classifier using Weka's
 * <code>Logistic</code> class.
 *
 * This class can be called from the command-line to train a classifier and save the resulting model
 * to a file.
 *
 * @author afader
 */
public class ReVerbOpenNlpClassifierTrainer {
    ...
    /**
     * Trains a logistic regression classifier using the examples in the given file, and saves the
     * model to disk. The examples must be in the format described in <code>LabeledBinaryExtractionReader</code>.
     */
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            ...
            System.err
                .println(
                    "    Trains the model used by ReVerbConfFunction on the given examples file and\n"
