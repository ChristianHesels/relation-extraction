package edu.washington.cs.knowitall.extractor.chunking.conf.opennlp;

import opennlp.maxent.GISModel;

import java.io.IOException;

import edu.washington.cs.knowitall.extractor.chunking.conf.ConfidenceFunctionException;
