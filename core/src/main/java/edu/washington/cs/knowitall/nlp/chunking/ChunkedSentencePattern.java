...
public class ChunkedSentencePattern {
    ...
    /**
     * This class compiles regular expressions over the ChunkedSentenceTokens in a sentence into an
     * NFA. There is a lot of redundancy in their expressiveness. This is largely because it
     * supports pattern matching on the fields This is not necessary but is an optimization and a
     * shorthand (i.e. {@code <pos="NNPS?"> is equivalent to "<pos="NNP" | pos="NNPS">} and {@code
     * (?:<pos="NNP"> | <pos="NNPS">)}. <p> Here are some equivalent examples: <ol> <li> {@code
     * <pos="JJ">* <pos="NNP.">+} <li> {@code <pos="JJ">* <pos="NNPS?">+} <li> {@code <pos="JJ">*
     * <pos="NNP" | pos="NNPS">+} <li> {@code <pos="JJ">* (?:<pos="NNP"> | <pos="NNPS">)+} </ol>
     * Note that (3) and (4) are not preferred for efficiency reasons. Regex OR (in example (4))
